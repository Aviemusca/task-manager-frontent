  ...
  <Container style={{ width: "60%" }}>
    <StyledCard style={{ marginTop: "6em" }}>
      ...
      <p>
        ...
        using the <a href="https://www.djangoproject.com/">Django framework</a>.
      ...
      <p>
        ...
        <a href="https://reactjs.org/">React</a> library. The CSS styles are a
        mixture of custom styled-components and{" "}
